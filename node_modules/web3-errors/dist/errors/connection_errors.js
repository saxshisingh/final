...
class ConnectionError extends web3_error_base_1.Web3Error {
    constructor(message, event) {
        super(message);
        this.code = error_codes_1.ERR_CONN;
        if (event) {
...
class InvalidConnectionError extends ConnectionError {
    constructor(host, event) {
        ...
        this.host = host;
        this.code = error_codes_1.ERR_CONN_INVALID;
    }
    toJSON() {
...
class ConnectionTimeoutError extends ConnectionError {
    constructor(duration) {
        ...
        this.code = error_codes_1.ERR_CONN_TIMEOUT;
    }
    toJSON() {
...
class ConnectionNotOpenError extends ConnectionError {
    constructor(event) {
        ...
        this.code = error_codes_1.ERR_CONN_NOT_OPEN;
    }
}
...
class ConnectionCloseError extends ConnectionError {
    constructor(event) {
        ...
        this.code = error_codes_1.ERR_CONN_CLOSE;
    }
}
...
class PendingRequestsOnReconnectingError extends ConnectionError {
    constructor() {
        ...
        this.code = error_codes_1.ERR_CONN_PENDING_REQUESTS;
    }
}
...
class RequestAlreadySentError extends ConnectionError {
    constructor(id) {
        ...
        this.code = error_codes_1.ERR_REQ_ALREADY_SENT;
    }
}
